...
namespace SagaciousTrove.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            _emailSender.SendEmailAsync(orderHeader.ApplicationUser.Email, "Order Placed - Sagacious Trove", "<p>Hi, Thank you for placing your order. Your order is ready to ship and will be delivered within the next 2-7 days. Thank you</p>");
